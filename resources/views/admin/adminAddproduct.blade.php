    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="d-flex justify-content-center w-100 align-items-center flex-column">
            <div class="card-body w-100">
                ...
                <form class="forms-sample" action="/dashboard/addnewproduct" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="quantity" id="exampleInputUsername1"
                            placeholder="Quantity">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputUsername1"> Price</label>
                        <input type="number" class="form-control" name="price" id="exampleInputUsername1"
                            placeholder="price">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputUsername1">Discount Price</label>
                        <input type="number" class="form-control" id="exampleInputUsername1" name="discount_price"
